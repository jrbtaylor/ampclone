# https://github.com/SiggiGue/pyfilterbank/blob/master/pyfilterbank/butterworth.py
# Jason's note: THESE ARE IIR FILTERS, MAYBE MORE SUITABLE FOR EMBEDDED IMPLEMENTATION BUT NOT PYTORCH
